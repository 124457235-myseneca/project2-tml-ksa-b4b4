[project2-tml-ksa-b4b4] Operating Details
====================================

Generated On: 2024-10-22 02:19:58 UTC
...
.. important::
   ...
   **not be valid if your [project2-tml-ksa-b4b4] container is NOT running**.

.. tip::
   You must have your [project2-tml-ksa-b4b4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=43675  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kasunsam/project2-tml-ksa-b4b4-amd64 (https://hub.docker.com/r/kasunsam/project2-tml-ksa-b4b4-amd64)
...
.. important::
   docker run -d -p 36549:36549 -p 40487:40487 -p 49679:49679 \-\-env TSS=0 \-\-env SOLUTIONNAME=project2-tml-ksa-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_dag-project2-tml-ksa-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=36549  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=40487  \-\-env SOLUTIONVIPERVIZPORT=49679 \-\-env DOCKERUSERNAME='kasunsam'  \-\-env EXTERNALPORT=43675 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasunsam/project2-tml-ksa-b4b4-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=49679
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=36549
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kasunsam/project2-tml-ksa-b4b4-amd64
...
It can be accessed by entering: http://localhost:40487
...
.. important::
   http://localhost:49679/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:49679/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:49679/<html file>
...
[project2-tml-ksa-b4b4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/124457235-myseneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/project2-tml-ksa-b4b4
...
.. important::
   https://project2-tml-ksa-b4b4.readthedocs.io
...
.. important::
   solution_preprocessing_dag-project2-tml-ksa-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=36549, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42251, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36175, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42855, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40719, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=42535, HPDEHOST=127.0.1.1, HPDEPORT=45007, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33065

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9555-project2-tml-ksa-b4b4,solution_preprocessing_dag-project2-tml-ksa-b4b4, python-preprocess-637-project2-tml-ksa-b4b4,solution_preprocessing_dag-project2-tml-ksa-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
